...
SECRET_KEY = 'django-insecure-v7^^%phrl4(^qzsj=y#rd^l8cy54ulwd!r^qo6bq_l_t+1ault'
...
SIMPLE_JWT = {
    ...
    "SLIDING_TOKEN_LIFETIME": timedelta(weeks=5),
    "SLIDING_TOKEN_REFRESH_LIFETIME": timedelta(weeks=10),
